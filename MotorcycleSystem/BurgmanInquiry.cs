...
namespace MotorcycleSystem
{
    public partial class BurgmanInquiry : Form
    {
        ...
        {
            string model = "Burgman Streeet 125";
            string price = "834000";
        ...
        private void SaveData(string model, string price, string downpayment, string name, string age, string gender, string nationality, string occupation, string contactnumber, string address)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT INTO burgman_tbl (Model, Price, Downpayment, Name, Age, Gender, Nationality, Occupation, ContactNumber, Address) VALUES (@Model, @Price, @Downpayment, @Name, @Age, @Gender, @Nationality, @Occupation, @ContactNumber, @Address)";
        ...
        {
           burgmanstreet burgmanstreet = new burgmanstreet();
            burgmanstreet.Show();
            this.Close();
        }
    }
