...
{
    public partial class nmax : Form
    {
        private readonly double givenNum = 151900;
        public nmax()
        {
            InitializeComponent();
        }
        ...
        private void nmax_Load(object sender, EventArgs e)
        {
        ...
        {
            NmaxInquiry nmaxInquiry = new NmaxInquiry();
            nmaxInquiry.Show();
            this.Close();
        }
