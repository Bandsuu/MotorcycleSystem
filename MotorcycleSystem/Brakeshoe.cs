...
{
    public partial class Brakeshoe : Form
    {
        ...
        private void SaveData(string Product, string Price, string quantity, string name, string address, DateTime orderTime)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT INTO brakeshoe_tbl (Product, Price, Quantity, Name, Address, OrderTime) VALUES (@Product, @Price, @Quantity, @Name, @Address, @OrderTime)";
        ...
        private void Brakeshoe_Load(object sender, EventArgs e)
        {
