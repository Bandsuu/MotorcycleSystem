...
{
    public partial class BrakePads : Form
    {
        ...
        private void BrakePads_Load(object sender, EventArgs e)
        {
        ...
        private void SaveData(string Product, string Price, string quantity, string name, string address, DateTime orderTime)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "INSERT INTO brakepads_tbl (Product, Price, Quantity, Name, Address, OrderTime) VALUES (@Product, @Price, @Quantity, @Name, @Address, @OrderTime)";
