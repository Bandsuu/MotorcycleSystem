...
{
    public partial class barakofi : Form
    {
        private readonly double givenNum = 100500;
        public barakofi()
        {
            InitializeComponent();
        }

        private void barakofi_Load(object sender, EventArgs e)
        {
        ...
        {
            BarakoFiInquiry barakoFiInquiry = new BarakoFiInquiry();
            barakoFiInquiry.Show();
            this.Close();
        }
