...
{
    public partial class click160 : Form
    {
        private readonly double givenNum = 122900;
        public click160()
        {
            InitializeComponent();
        }
        ...
        private void click160_Load(object sender, EventArgs e)
        {
        ...
        {
            Click160Inquiry click160Inquiry = new Click160Inquiry();
            click160Inquiry.Show();
            this.Close();
        }
