...
{
    public partial class avenis : Form
    {
        private readonly double givenNum = 80400;
        public avenis()
        {
            InitializeComponent();
        }
        ...
        private void avenis_Load(object sender, EventArgs e)
        {
        ...
        {
            AvenisInquiry avenisInquiry = new AvenisInquiry();
            avenisInquiry.Show();
            this.Close();
        }
